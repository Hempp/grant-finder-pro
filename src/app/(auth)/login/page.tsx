    ...
    <Card className="w-full max-w-md p-5 sm:p-8 glass-card animate-reveal">
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-medium py-2.5 px-4 rounded-lg transition-colors disabled:opacity-50"
        >
        ...
        <button
          ...
          disabled={!!socialLoading}
          className="w-full flex items-center justify-center gap-3 bg-slate-800 hover:bg-slate-700 text-white font-medium py-2.5 px-4 rounded-lg border border-slate-700 transition-colors disabled:opacity-50"
        >
