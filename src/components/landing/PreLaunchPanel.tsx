  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 py-20 md:py-28">
      <div className="rounded-2xl border border-[color:var(--section-border-2)] bg-[image:var(--panel-prelaunch)] px-8 py-14 md:px-16 md:py-20 text-center max-w-5xl mx-auto">
        ...
        <p className="text-body md:text-body-lg leading-[1.6] text-ink-2 max-w-[58ch] mx-auto mb-8">
          We&apos;re building in the open. Your story replaces this section
          the moment we have permission to tell it.
        </p>
        <a
          href="/signup"
          className="inline-flex items-center gap-2 text-body-sm font-semibold text-accent hover:text-ink transition-colors duration-[var(--dur-fast)] ease-[var(--ease-out)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        >
