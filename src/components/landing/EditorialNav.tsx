      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center bg-accent text-surface text-caption font-medium tracking-tight rounded-lg px-3.5 py-2 hover:bg-ink transition-colors duration-[var(--dur-fast)] ease-[var(--ease-out)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
          >
