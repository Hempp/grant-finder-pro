    ...
    <section id="pricing" className="container mx-auto px-4 sm:px-6 py-12 md:py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <article className="rounded-2xl border border-rule p-8 lg:p-10 bg-surface">
          <p className="text-micro font-semibold tracking-[0.14em] uppercase text-accent mb-3">
          ...
          <dl className="mb-6 mt-4">
            ...
            <dd className="flex items-baseline gap-2">
              <span className="text-display-xl font-mono font-bold leading-none tracking-[-0.02em] text-ink tabular-nums">0%</span>
              <span className="text-body text-ink-2">upfront</span>
            </dd>
            <dt className="sr-only">Billing</dt>
            <dd className="text-small text-ink-2 mt-2">Pay only on grants won — 2–5 % success fee.</dd>
          </dl>
          <ul className="space-y-3 mb-8">
            {ORG_FEATURES.map((f) => (
              <li key={f} className="flex items-start gap-2.5 text-small text-ink">
        ...
        <article className="rounded-2xl border border-rule p-8 lg:p-10 bg-surface">
          ...
          <dl className="mb-6 mt-4">
            <dt className="sr-only">Price</dt>
            <dd className="flex items-baseline gap-2">
              <span className="text-display-xl font-mono font-bold leading-none tracking-[-0.02em] text-ink tabular-nums">$9.99</span>
              <span className="text-body text-ink-2">/ month</span>
            </dd>
            <dt className="sr-only">Billing</dt>
            <dd className="text-small text-ink-2 mt-2">Auto-apply to scholarships you qualify for. Cancel anytime.</dd>
          </dl>
          <ul className="space-y-3 mb-8">
